...
@testset "partially implemented block array" begin
    ...
    try
        ...
        @test err isa ErrorException && err.msg == "axes for PartiallyImplementedBlockVector is not implemented"
    end
end
...
@testset "non-standard BlockSizes" begin
    ...
    @test A isa BlockMatrix{Int,Matrix{Matrix{Int}},NTuple{2,BlockArrays.CumsumBlockRange{StepRange{Int64,Int64}}}}
    A = BlockArray([1 2; 3 4], Fill(1,2),[1,1])
    @test A isa BlockMatrix{Int,Matrix{Matrix{Int}},Tuple{BlockArrays.CumsumBlockRange{StepRange{Int64,Int64}},BlockArrays.CumsumBlockRange{Vector{Int}}}}
end
